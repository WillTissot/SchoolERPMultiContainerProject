...
This program is design to be used as an ERP program for a university or a school.
...
Launch app only with docker compose
...
Inside the same directory insert the following commands:https://github.com/itp21116/schoolerpmulticontainerproject.git
